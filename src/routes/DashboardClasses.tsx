...
export default function DashboardClasses() {
  ...
  return (
    <div className="flex w-full flex-col items-center gap-8 p-2 md:flex-row md:items-start">
      <div className="w-full space-y-8">
        <div className="flex flex-col justify-between gap-2 rounded-[6.25px] border bg-[#dfdede43] p-2 shadow-sm shadow-[#dfdede43]">
          ...
          <img src={lesson.creatorImage} alt="" className="h-[46px] w-[46px]" />
      ...
      <div className="mx-auto w-full space-y-4 text-center">
        <div className="mx-auto w-full space-x-2 space-y-3 min-[359px]:space-y-0">
          <button
            type="button"
            className="mx-auto w-[148px] rounded-[78px] border border-[#06031E] bg-[#06031E] py-[8px] text-base font-medium text-white hover:bg-white hover:text-[#06031E]"
          >
            Amanda Chisom
          </button>
          <button
            type="button"
            className="mx-auto w-[148px] rounded-[78px] border border-[#92929D] bg-white py-[8px] text-[#92929D] hover:bg-[#06031E] hover:text-white"
          >
            Related Classes
          </button>
        </div>
